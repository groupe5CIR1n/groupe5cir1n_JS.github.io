...
// Function executed when we copy a number
function copyNum(){
    ...
    if(confirm=="0298038400" || confirm=="0230310320" || confirm=="0230130560" || confirm == "0299330436"){ // If it's equal to one of the numbers...
        console.log("on appelle le n°",confirm) // We show it in the logs
        let sonnerie = new Audio("../gif_and_mp3/Sonnerie.mp3"); // Play the audio tune
        sonnerie.play();
